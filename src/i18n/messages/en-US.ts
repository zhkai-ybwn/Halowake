export default {
  ...
  codexReport: {
    ...
    promptTitle: 'Daily Report Prompt Template',
    promptHint: 'This template is copied together with the work facts to send directly to free web AI (Claude / ChatGPT / DeepSeek).',
    restoreDefault: 'Restore Default',
    presetTemplateSelect: 'Preset Templates',
    selectDateRange: 'Choose a date range',
    promptSaved: 'Daily report prompt saved',
  ...
  gitAssistant: {
    ...
    files: {
      ...
      scoring: 'Analyzing…',
      scoreNotice:
        'Scoring does not use AI. It uses project configuration and local algorithms for reference only. Select files and use Code Review for deeper analysis.',
      scoreHelpLabel: 'About review scoring',
      scoreProgressPreparing: 'Preparing analysis…',
      scoreProgressProfile: 'Reading project configuration and review rules…',
